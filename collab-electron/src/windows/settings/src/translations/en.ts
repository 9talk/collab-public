export const en = {
  ...
  "claude.soundEvent.SessionStart": "Session start",
  "claude.soundEvent.SessionEnd": "Session end",
  "claude.soundEvent.PreToolUse": "Before tool use",
  "claude.soundEvent.PostToolUseFailure": "Tool use failed",
  "claude.soundEvent.SubagentStart": "Subagent start",
  "claude.soundEvent.SubagentStop": "Subagent stop",
  ...
  "remote.credentialSection": "Credential",
  "remote.credentialDesc":
    "Export a credential file and import it on the client. Issuing a new one revokes the previous client immediately.",
  "remote.credentialFingerprint": "Fingerprint",
  "remote.issueCredential": "Issue new credential…",
  "remote.issuing": "Issuing…",
  "remote.issueFailed": "Failed to issue credential",
