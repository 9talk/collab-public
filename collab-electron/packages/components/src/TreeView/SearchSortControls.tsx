  ...
  (
    ...
    return (
      <div className="table-search-row">
        {leadingContent ? (
          <div className="table-search-leading">{leadingContent}</div>
        ) : null}
        {onToggleListView && (
          <div
            className={`nav-view-toggle${searchQuery?.trim() ? " hidden" : ""}`}
          >
            {!searchQuery?.trim() && (
              <>
                <button
          ...
          <input
            ...
            onKeyDown={(e) => {
              ...
              if (
                ...
                e.preventDefault();
                onArrowNav(e.key === "ArrowDown" ? "down" : "up", e.shiftKey);
              }
            }}
